...
void testDualWheel()
{
  ...
  RUN_TEST(test_dualwheel_state_secondary_pulse_establishes_sync_and_primes_primary);
  RUN_TEST(test_dualwheel_state_first_primary_after_sync_wraps_and_counts_revolution);
  RUN_TEST(test_dualwheel_state_short_secondary_gap_is_filtered);
  RUN_TEST(test_dualwheel_state_resync_counts_sync_loss_and_resets_tooth);
