...
#include "globals.h" // Needed for FPU_MAX_SIZE
  ...
  #define LOG_ENTRY_SIZE      148 /**< The size of the live data packet. This MUST match ochBlockSize setting in the ini file (Phase 10: +4 startRevolutions, +1 runtimeStatusA = bytes 143-147) */
#else
