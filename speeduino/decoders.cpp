...
#if defined(UNIT_TEST)
bool testUpdateRevolutionTimeFromTeeth(bool isCamTeeth)
{
  return UpdateRevolutionTimeFromTeeth(isCamTeeth);
}

uint16_t testRpmFromRevolutionTimeUs(uint32_t revTime)
{
  return RpmFromRevolutionTimeUs(revTime);
}

int testCrankingGetRPM(byte totalTeeth, bool isCamTeeth)
{
  return crankingGetRPM(totalTeeth, isCamTeeth);
}
