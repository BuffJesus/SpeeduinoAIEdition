...
- Keep using the forum/manual evidence pipeline as a primary source for blocked decoder work:
  ...
  - the `Renix` current-code virtual-tooth advancement / short-gap filtering / fourth-group wrap contract is now documented in [SESSION_HANDOFF_2026-03-23_RENIX_STATE.md](C:/Users/Cornelio/Desktop/speeduino-202501.6/speeduino/SESSION_HANDOFF_2026-03-23_RENIX_STATE.md) and has direct AVR state coverage in [renix.cpp](C:/Users/Cornelio/Desktop/speeduino-202501.6/test/test_decoders/renix/renix.cpp), complementing the replay-backed slice with explicit valid-group advancement, isolated short-gap rejection, and synced wrap assertions
